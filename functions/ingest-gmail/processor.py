...
class GmailProcessor:
    ...
    def search_emails(self, query: str = 'label:inbox', max_results: int = 10) -> List[str]:
        ...
        try:
            ...
            logger.error(f"[GmailProcessor] Search error: {e}", exc_info=True)
            return []
    ...
    def get_email_details(self, message_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"[GmailProcessor] Get details error: {e}", exc_info=True)
            return {}
    ...
    def extract_attachments(self, message_id: str, part: Dict[str, Any]) -> bytes:
        ...
        try:
            ...
            logger.error(f"[GmailProcessor] Extract attachment error: {e}", exc_info=True)
            return b''
